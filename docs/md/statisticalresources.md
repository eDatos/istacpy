...
Apart from all the functions below, there are **two special calls** we can use in order to get a [pandas DataFrame](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.html) instead of the usual json API response:
