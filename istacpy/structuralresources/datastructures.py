...
def get_structuralresources_content_constraints(limit=25, offset=0, query=None, orderby=None):
...
def get_structuralresources_content_constraints_agency(agencyid, limit=25, offset=0, query=None, orderby=None):
...
def get_structuralresources_content_constraints_agency_resource(agencyid, resourceid, limit=25, offset=0, query=None,
                                                                orderby=None):
...
def get_structuralresources_content_constraints_agency_resource_version(agencyid, resourceid, version):
...
def get_structuralresources_content_constraints_agency_resource_version_regions(regioncode, agencyid, resourceid,
                                                                                version):
    """Get content constraints agency resource version regions

    This function returns the content from /v1.0/contentConstraints/{agencyID}/{resourceID}/{version}/regions/
    {regionCode}
    ...
    Examples:
        >>> get_structuralresources_content_constraints_agency_resource_version_regions("0001", "ISTAC", "CL_AREA",
            "01.000")
    """
    # Build URL
    api = "structural-resources"
...
def get_structuralresources_data_structures_agency(agencyid, limit=25, offset=0, query=None, orderby=None):
...
def get_structuralresources_data_structures_agency_resource(agencyid, resourceid, limit=25, offset=0, query=None,
                                                            orderby=None):
...
def get_structuralresources_data_structures_agency_resource_version(agencyid, resourceid, version):
